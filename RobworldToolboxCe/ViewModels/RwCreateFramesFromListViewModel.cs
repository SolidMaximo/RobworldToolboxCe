...
using RobworldToolboxCe.Utilities;
using System;
...
namespace RobworldToolboxCe.ViewModels
{
    ...
    /// </summary>
    public class RwCreateFramesFromListViewModel : RwPropertyChangedNotifier
    {
        #region Fields
        ...
        /// </summary>
        public ObservableCollection<RwFrameCreationData> FramesData { get; set; }
        ...
        public RwCreateFramesFromListViewModel()
        {
            ...
            FramesData = new ObservableCollection<RwFrameCreationData>();
            FramePrefix = "fr_";
        ...
        private void ReadFrameData()
        {
            try
            {
                ...
                foreach (string frameData in framesData)
                {
                    ...
                    {
                        RwFrameCreationData creationData = new RwFrameCreationData(frameNameInFile, transX, transY, transZ, rotX, rotY, rotZ)
                        {
