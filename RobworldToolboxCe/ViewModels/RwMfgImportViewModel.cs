...
{
    /// <summary>
    /// Import manufacturing features from a list on the file system
    /// </summary>
    public class RwMfgImportViewModel : RwPropertyChangedNotifier
    {
        #region Fields
        ...
        /// </summary>
        public string Title { get { return "Manufacturing features Importer"; } }
        ...
        /// </summary>
        /// <param name="emsCacheManager">Cache manager feor emServer fields</param>
