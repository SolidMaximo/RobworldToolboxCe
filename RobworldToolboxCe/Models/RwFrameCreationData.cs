...
namespace RobworldToolboxCe.Models
{
    ...
    /// </summary>
    public class RwFrameCreationData : RwPropertyChangedNotifier
    {
        #region Fields
        private string name;
        private double x;
        ...
        public RwFrameCreationData(string originalName)
        {
        ...
        public RwFrameCreationData(string originalName, double x, double y, double z, double rx, double ry, double rz) : this(originalName)
        {
            X = x;
            Y = y;
            Z = z;
